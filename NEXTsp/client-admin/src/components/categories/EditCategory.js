...
const EditCategoryModal = (props) => {
  ...
  useEffect(() => {
    setName(data.editCategoryModal.nameCategory);
    setDes(data.editCategoryModal.description);
    setStatus(data.editCategoryModal.status);
    setid(data.editCategoryModal._id);
  ...
  const submitForm = async () => {
    ...
    let edit = await editCategory(_id, description, status, nameCategory);
    if (edit.error) {
